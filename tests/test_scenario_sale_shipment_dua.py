...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        activate_modules('sale_shipment_dua')
        ...
        self.assertEqual(dua_line.amount, Decimal('3.00'))
        ...
        self.assertEqual(cost_line.amount, Decimal('3.00'))
        dua_line, = [x for x in sale.lines if x.product == carrier_dua_product]
        self.assertEqual(dua_line.amount, Decimal('30.00'))

        # Duplicate sale
        sale_copy, = sale.duplicate()
        sale_copy.click('quote')
        self.assertEqual(sale_copy.total_amount == sale.total_amount, True)
